...
export default function ProductInfo(props: any) {
  ...
  return (
    ...
    >
      <Box sx={style}>
        <Grid container direction='column' spacing='2rem' padding='30px' alignItems='center' justifyItems='center'>
          <Grid item xs={12}>
            <Img
              width='800'
              src={props.image}
          ...
          <Grid item xs={12}>
            <Grid container direction='column' spacing={2} alignItems='center' justifyItems='center'>
              <Grid item xs>
                <Typography
                  gutterBottom
                  variant='h4'
