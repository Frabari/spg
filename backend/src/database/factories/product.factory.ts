...
const products = [
  {
    ...
    unitOfMeasure: ProductMeasures.UNIT,
  },
  {
    ...
    unitOfMeasure: ProductMeasures.HG,
  },
  {
    name: 'Green Kiwis',
    ...
    unitOfMeasure: ProductMeasures.KG,
  },
  {
...
define(Product, (faker: typeof Faker) => {
  ...
  product.unitOfMeasure = products[i++ % products.length].unitOfMeasure;
  return product;
});
